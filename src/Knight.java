...
public class Knight extends Piece {
    ...
    public ArrayList<Board.Tile> getMoves(int currX, int currY) {
        ...
        if ((y > 1 && x > 0)
                && (!chessBoard.Tiles[y - 2][x - 1].isOccupied || (chessBoard.Tiles[y - 2][x - 1].isOccupied
                        && (isWhite != chessBoard.Tiles[y - 2][x - 1].currentPiece.isWhite)))
                && IsKingProtected(x - 1, y - 2)) {
        ...
        if ((y > 0 && x > 1)
                && (!chessBoard.Tiles[y - 1][x - 2].isOccupied || (chessBoard.Tiles[y - 1][x - 2].isOccupied
                        && (isWhite != chessBoard.Tiles[y - 1][x - 2].currentPiece.isWhite)))
                && IsKingProtected(x - 2, y - 1)) {
